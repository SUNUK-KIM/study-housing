...
exports.publishPackage = function (options) { return __awaiter(_this, void 0, void 0, function () {
    var workingDir, pkg, scripts, changeDirCmd, scriptRunCmd, scriptNames, copyRes, scriptNames, publishedPackageDir, publishedPkg, installationsConfig, installationPaths, installationsToRemove, _i, installationPaths_1, workingDir_1, installationsToRemoveForPkg;
        ...
        switch (_a.label) {
            case 0:
                ...
                if (scriptRunCmd) {
                    ...
                    scriptNames
                        .filter(function (name) { return !!scripts[name]; })
                        .forEach(function (scriptName) {
                        var scriptCmd = scripts[scriptName];
