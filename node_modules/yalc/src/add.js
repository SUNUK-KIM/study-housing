...
exports.addPackages = function (packages, options) { return __awaiter(_this, void 0, void 0, function () {
    var workingDir, localPkg, localPkgUpdated, pnpmWorkspace, doPure, addedInstallsP, addedInstalls;
    var _this = this;
                                ...
                                if (doPure) {
                                    if (!options.pure) {
                                        ...
                                        if (localPkg.workspaces) {
                                            console.log('Because of `workspaces` enabled in this package ' + defaultPureMsg);
                                        }
                                        else if (pnpmWorkspace) {
                                            console.log('Because of `pnpm-workspace.yaml` exists in this package ' +
                                                defaultPureMsg);
                                        }
                                    }
